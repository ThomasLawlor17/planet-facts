	...
	return (
		<svg
			...
			<defs>
				...
				<circle id="e" cx="225" cy="225" r="225"></circle>
				<circle id="g" cx="225" cy="225" r="225"></circle>
				<circle id="i" cx="225" cy="225" r="225"></circle>
				<path
					id="k"
					d="M0 0c120.398 0 218 97.602 218 218S120.398 436 0 436z"></path>
			</defs>
			<g fill="none" fillRule="evenodd">
				...
				<path
					...
					mask="url(#j)"
					opacity=".078"
					d="M225 11h215.354v428H225z"></path>
				<g transform="translate(225 7)">
					<mask id="l" fill="#fff">
						<use href="#k"></use>
					</mask>
					<use fill="#94D5FF" href="#k"></use>
					<circle cy="218" r="211" fill="#2959C9" mask="url(#l)"></circle>
					<circle cy="218" r="147" fill="#6593FF" mask="url(#l)"></circle>
					<circle cy="218" r="82" fill="#4A7AE9" mask="url(#l)"></circle>
					<circle cy="218" r="32" fill="#042570" mask="url(#l)"></circle>
				</g>
			</g>
		</svg>
	);
