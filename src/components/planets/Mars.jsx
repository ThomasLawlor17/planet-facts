...
const Mars = () => {
	return (
		<svg id="mars" viewBox="0 0 336 336">
			<defs>
				<circle id="a" cx="168" cy="168" r="168"></circle>
				<circle id="c" cx="168" cy="168" r="168"></circle>
				<circle id="e" cx="168" cy="168" r="168"></circle>
				<circle id="g" cx="168" cy="168" r="168"></circle>
			</defs>
